...
func main() {
	...
	answer := baseStr[:kk[k-2][1]+1]
	moveStr := baseStr[kk[k-1][0] : kk[k-1][1]+1]
	middle := baseStr[kk[k-2][1]+1 : kk[k-1][0]]
	after := baseStr[kk[k-1][1]+1:]

	answer += moveStr + middle + after
